...
public class ImageUtil {
     ...
     * 图片上传
     *
     * @param multipartFile 图片IO
     * @param srcImageFile  存储路径
     * @param scale         缩放比例
     * @param flag          缩放选择:true 放大; false 缩小;
     * @return
     */
    public final static Map<String, String> uploadImage(MultipartFile multipartFile,
                                                        String srcImageFile,
                                                        int scale,
                                                        boolean flag) {
        ...
        String smallImageName = "s_" + imageName;
        // 原图存储地址
        String imagePath = srcImageFile + imageName;
        // 小图存储地址
        String smallImagePath = srcImageFile + smallImageName;
        try {
            ...
            map.put("imagePath", dest.getName());
            // 小图上传
            map.put("smallImagePath", scale(imagePath, smallImagePath, scale, flag));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return map;
     ...
     * @param flag         缩放选择:true 放大; false 缩小;
     */
    public final static String scale(String srcImageFile, String result,
