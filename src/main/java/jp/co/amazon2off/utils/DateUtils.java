...
public class DateUtils {
     ...
     * @return
     */
    public static long getTimeByDate(String time, String format) {
     ...
     * @return
     */
    public static Long[] getBeforeTwoDay() {
        Long times[] = new Long[2];
        // 获取前一天0点时间戳
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd 00:00:00");
        Calendar cBeforeDay = Calendar.getInstance();
        cBeforeDay.add(Calendar.DATE, -1);
        Date beforeDay = cBeforeDay.getTime();
        times[0] = getTimeByDate(sdf.format(beforeDay), "yyyy-MM-dd HH:mm:ss");

        // 获取后一天的0点时间戳
        Calendar cAfterDay = Calendar.getInstance();
        cAfterDay.add(Calendar.DATE, 1);
        Date afterDay = cAfterDay.getTime();
        times[1] = getTimeByDate(sdf.format(afterDay), "yyyy-MM-dd HH:mm:ss");
        return times;
    }
